...
const userSchema = new mongoose.Schema({
  ...
  password: { type: String, required: [true, 'Please include a password'], minLength: 3 }
}, { 
  timestamps: true,

  // Even though it's hashed - don't serialize the password (won't return the password to us when finding)
  toJSON: {
...
userSchema.pre('save', async function(next) {
  ...
  // If the doc is unmodified, move on
